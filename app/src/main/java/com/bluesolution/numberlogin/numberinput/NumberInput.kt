package com.bluesolution.numberlogin.numberinput
...
import com.bluesolution.numberlogin.MainActivity
import com.bluesolution.numberlogin.R
...
class NumberInput : AppCompatActivity() {
    ...
    private val viewModel: NumberInputViewModel by viewModels()
